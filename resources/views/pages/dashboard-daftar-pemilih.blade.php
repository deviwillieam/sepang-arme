...
<script> 
$(document).on('click','.redirect_me',function(){ 
	$(window).attr('location','http://redirect_this_page.com')  
}); 
</script> 
<style>
.container { 
...
<div class="container">
  <div class="center">
    <button><a href="https://mysprsemak.spr.gov.my/semakan" target="_blank" class="redirect_me">IM A BUTTON </a> </button>
  </div>
</div>
<br>
<br>
