...
@section('subhead')
<title>Pusat Daerah Pengundi</title>
@endsection
...
<div class="embed-container">
  <div id="content">
    <div style="height:580px;width:960px">
      <iframe width="1920" height="1080" src="{{ $user->pusat_daerah }}" frameborder="0" height="100%" width="100%" style="position:absolute; clip:rect(0px,1920px,750px,0px);
